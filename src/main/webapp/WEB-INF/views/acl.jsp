...
<script type="text/javascript">
    $(function() {
        ...
        function loadAclModuleTree() {
            $.ajax({
                url: "<%=request.getContextPath() %>/sys/aclModule/tree.json",
        ...
        function updateAclModule(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "<%=request.getContextPath() %>/sys/aclModule/save.json" : "/sys/aclModule/update.json",
        ...
        function updateAcl(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "<%=request.getContextPath() %>/sys/acl/save.json" : "/sys/acl/update.json",
        ...
        function loadAclList(aclModuleId) {
            ...
            var url = "<%=request.getContextPath() %>/sys/acl/page.json?aclModuleId=" + aclModuleId;
