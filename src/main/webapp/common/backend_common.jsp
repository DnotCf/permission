...
<!-- text fonts -->
<link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/google-fonts.css"/>
<!-- ace styles -->
<link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/ace.min.css"/>
<!--[if lte IE 9]>
<link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/ace-part2.min.css"/>
<![endif]-->
...
<script src="https://cdn.bootcss.com/mustache.js/2.2.1/mustache.js"></script>
